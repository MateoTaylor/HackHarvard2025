...
from app import MERCHANT_API_KEYS, MFA_AMOUNT_THRESHOLD, HIGH_RISK_COUNTRIES
...
def test_should_require_mfa():
    assert should_require_mfa(MFA_AMOUNT_THRESHOLD + 1, "USD", None, None, "test@example.com") == (True, "high_amount")
